...
//   }
//
//   static Future<bool> sendOtp({String recieverMail,int otpLength}) async {
//     try {
...
//           "https://app-authenticator.herokuapp.com/auth/${recieverMail.toLowerCase()}?CompanyName=$sessionName&otpLength=$otpLength"));
